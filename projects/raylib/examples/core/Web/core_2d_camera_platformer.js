...
// include: /tmp/tmpk5ovqij7.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/media/projectos/projects/python/crosside/projects/raylib/examples/core/Web//core_2d_camera_platformer.data';
...
Module['FS_createPath']("/", "resources", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_/media/projectos/projects/python/crosside/projects/raylib/examples/core/Web//core_2d_camera_platformer.data');
      }
      Module['addRunDependency']('datafile_/media/projectos/projects/python/crosside/projects/raylib/examples/core/Web//core_2d_camera_platformer.data');
    ...
    loadPackage({"files": [{"filename": "/resources/LICENSE.md", "start": 0, "end": 346}, {"filename": "/resources/distortion100.fs", "start": 346, "end": 2057}, {"filename": "/resources/distortion330.fs", "start": 2057, "end": 3939}, {"filename": "/resources/ps3.png", "start": 3939, "end": 23219}, {"filename": "/resources/save.mrb", "start": 23219, "end": 23421}, {"filename": "/resources/xbox.png", "start": 23421, "end": 39533}], "remote_package_size": 39533});

  })();

// end include: /tmp/tmpk5ovqij7.js
// include: /tmp/tmphiofbxaz.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmphiofbxaz.js
// include: /tmp/tmpms9yuavk.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpms9yuavk.js
