...
ANDROID_SDK="/home/djoker/android/android-sdk"
ANDROID_NDK="/home/djoker/android/android-ndk-r27d"
...
JAVA_SDK   ='/usr/lib/jvm/java-11-openjdk-amd64'
# JDK 8 uses rt.jar; JDK 9+ no longer ships it.
JAVA_LIB_RT=os.path.join(JAVA_SDK,'jre','lib','rt.jar')
if not os.path.exists(JAVA_LIB_RT):
    JAVA_LIB_RT=""
...
def androidCompileJavaFx(mainRoot,appName,ANDROID_PACK,ANDROID_ACTIVITY):
    ...
    if useDX8:
        ...
        args.append("--lib")
        args.append(PLATFORM)
        if JAVA_LIB_RT and os.path.exists(JAVA_LIB_RT):
            args.append("--classpath")
            args.append(JAVA_LIB_RT)
